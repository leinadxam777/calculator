function equivalentCheck() { // This allows the last value to remain in view until other button has been pressed.
...
function decimalPoint() {
    ...
    if (parseInt(document.getElementById('operation').value)) { //Empty string will return false.
        document.getElementById('result').value = 0;
    }
}
...
function operandCheck() {
    if(document.getElementById('operand').value == "") {
        ...
        //document.getElementById('result').value = 0; //Temporary
...
function operators(x) {
    ...
    switch(x) {
        ...
        case 1:
            document.getElementById('operation').value = 1; //addtion
            break;
        case 2:
